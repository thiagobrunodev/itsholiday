<template>
    <div id="app">
        ...
        <router-view />
        <p class="credits">
            <a title="Repository of this project" href="http://github.com/thiaguz/itsholiday"
                >Made with 💙</a
            >
            by
            <a title="My website" href="https://thiaguz.github.io/">Thiago B. Vieira</a>
            using <a title="Vue.Js" href="https://vuejs.org/">Vue</a> and
            <a title="Worldwide Public Holidays - Nager.Date" href="https://date.nager.at/"
                >Nager.Date</a
            >, art from <a title="unDraw" href="https://undraw.co/">unDraw</a>
        </p>
    </div>
</template>
...
export default {
    metaInfo: {
        ...
        link: [{ rel: 'canonical', href: 'https://itsholiday.now.sh/' }],
    },
    components: {
